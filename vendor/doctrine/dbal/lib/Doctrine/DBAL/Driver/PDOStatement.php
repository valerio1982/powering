...
class PDOStatement extends \PDOStatement implements Statement
{
     ...
     * {@inheritdoc}
     */
    public function columnCount($columnIndex = 0)
    {
        try {
            return parent::columnCount($columnIndex);
        } catch (\PDOException $exception) {
            throw new PDOException($exception);
        }
    }
     ...
     * {@inheritdoc}
     */
    public function rowCount($columnIndex = 0)
    {
        try {
            return parent::rowCount($columnIndex);
        } catch (\PDOException $exception) {
            throw new PDOException($exception);
        }
    }
     ...
     * {@inheritdoc}
     */
    public function errorCode($columnIndex = 0)
    {
        try {
            return parent::errorCode($columnIndex);
        } catch (\PDOException $exception) {
            throw new PDOException($exception);
        }
    }
